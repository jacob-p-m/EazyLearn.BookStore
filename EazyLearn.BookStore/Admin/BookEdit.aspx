...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	<h3>Book Table</h3>
	<div>
		<asp:GridView ID="gvBookList" runat="server" AutoGenerateColumns="False" OnRowEditing="gvBookList_RowEditing1" PageSize="8" CellPadding="10" AllowPaging="True" OnPageIndexChanging="gvBookList_PageIndexChanging">
